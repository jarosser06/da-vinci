...
class ResourceAccessPolicy(Construct):
    def __init__(
        self,
        policy_statements: list[cdk_iam.PolicyStatement],
        resource_name: str,
        resource_type: str,
        scope: Construct,
        app_name: str | None = None,
    ...
    @classmethod
    def policy_from_resource_name(
        cls,
        request: ResourceAccessRequest,
        scope: Construct,
        app_name: str | None = None,
        construct_id_prefix: str | None = None,
        deployment_id: str | None = None,
    ) -> cdk_iam.ManagedPolicy:
        """
    ...
    def multi_policy_import(
        cls,
        resource_access_requests: list[ResourceAccessRequest],
        scope: Construct,
        app_name: str | None = None,
        construct_id_prefix: str | None = None,
        deployment_id: str | None = None,
    ) -> list[cdk_iam.ManagedPolicy]:
        """
