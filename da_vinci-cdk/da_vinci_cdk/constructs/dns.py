...
class CName(Construct):
    def __init__(self, record_name: str, scope: Construct,
                 value: str, app_name: Optional[str] = None,
                 construct_id: Optional[str] = None, deployment_id: Optional[str] = None,
                 domain_name: Optional[str] = None) -> None:
        """
...
class PublicDomain(Construct):
    def __init__(self, domain_name: str, scope: Construct, app_name: Optional[str] = None,
                 construct_id: Optional[str] = None, deployment_id: Optional[str] = None, 
                 sub_domain_of: Optional[str] = None) -> None:
    ...
    @staticmethod
    def hosted_zone_from_name(name: str, scope: Construct, app_name: Optional[str] = None,
                              deployment_id: Optional[str] = None) -> cdk_route53.IHostedZone:
        """
